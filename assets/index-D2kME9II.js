...
`].filter($s).join(`
`)),a=xl(a),a=Lh(a,t),a=Ih(a,t),o=xl(o),o=Lh(o,t),o=Ih(o,t),a=Ph(a),o=Ph(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+f);const S=b+p+a,T=b+f+o,P=Rh(s,s.VERTEX_SHADER,S),R=Rh(s,s.FRAGMENT_SHADER,T);s.attachShader(v,P),s.attachShader(v,R),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function C(E){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(v).trim(),V=s.getShaderInfoLog(P).trim(),q=s.getShaderInfoLog(R).trim();let ee=!0,X=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(ee=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,P,R);else{const ne=Ch(s,P,"vertex"),K=Ch(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
Program Info Log: `+W+`
`+ne+`
`+K)}else W!==""?console.warn("THREE.WebGLProgram: Program Info Log:",W):(V===""||q==="")&&(X=!1);X&&(E.diagnostics={runnable:ee,programLog:W,vertexShader:{log:V,prefix:p},fragmentShader:{log:q,prefix:f}})}s.deleteShader(P),s.deleteShader(R),O=new na(s,v),j=q0(s,v)}let O;this.getUniforms=function(){return O===void 0&&C(this),O};let j;this.getAttributes=function(){return j===void 0&&C(this),j};let _=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return _===!1&&(_=s.getProgramParameter(v,O0)),_},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(v),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=B0++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=P,this.fragmentShader=R,this}let sv=0;class rv{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new av(e),t.set(e,n)),n}}class av{constructor(e){this.id=sv++,this.code=e,this.usedTimes=0}}function ov(i,e,t,n,s,r,a){const o=new sc,l=new rv,c=new Set,h=[],u=s.logarithmicDepthBuffer,d=s.reverseDepthBuffer,m=s.vertexTextures;let g=s.precision;const v={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function p(_){return c.add(_),_===0?"uv":`uv${_}`}function f(_,E,W,V,q){const ee=V.fog,X=q.geometry,ne=_.isMeshStandardMaterial?V.environment:null,K=(_.isMeshStandardMaterial?t:e).get(_.envMap||ne),re=K&&K.mapping===Aa?K.image.height:null,ce=v[_.type];_.precision!==null&&(g=s.getMaxPrecision(_.precision),g!==_.precision&&console.warn("THREE.WebGLProgram.getParameters:",_.precision,"not supported, using",g,"instead."));const pe=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,Xe=pe!==void 0?pe.length:0;let $e=0;X.morphAttributes.position!==void 0&&($e=1),X.morphAttributes.normal!==void 0&&($e=2),X.morphAttributes.color!==void 0&&($e=3);let $,te,me,he;if(ce){const Gt=yn[ce];$=Gt.vertexShader,te=Gt.fragmentShader}else $=_.vertexShader,te=_.fragmentShader,l.update(_),me=l.getVertexShaderID(_),he=l.getFragmentShaderID(_);const Te=i.getRenderTarget(),Se=q.isInstancedMesh===!0,Ge=q.isBatchedMesh===!0,qe=!!_.map,ze=!!_.matcap,D=!!K,Ct=!!_.aoMap,He=!!_.lightMap,We=!!_.bumpMap,we=!!_.normalMap,je=!!_.displacementMap,Ee=!!_.emissiveMap,w=!!_.metalnessMap,M=!!_.roughnessMap,A=_.anisotropy>0,x=_.clearcoat>0,L=_.dispersion>0,F=_.iridescence>0,Z=_.sheen>0,k=_.transmission>0,G=A&&!!_.anisotropyMap,ye=x&&!!_.clearcoatMap,Q=x&&!!_.clearcoatNormalMap,ae=x&&!!_.clearcoatRoughnessMap,Ae=F&&!!_.iridescenceMap,be=F&&!!_.iridescenceThicknessMap,fe=Z&&!!_.sheenColorMap,Ue=Z&&!!_.sheenRoughnessMap,Ie=!!_.specularMap,st=!!_.specularColorMap,U=!!_.specularIntensityMap,ue=k&&!!_.transmissionMap,Y=k&&!!_.thicknessMap,J=!!_.gradientMap,oe=!!_.alphaMap,de=_.alphaTest>0,Ye=!!_.alphaHash,pt=!!_.extensions;let Vt=li;_.toneMapped&&(Te===null||Te.isXRRenderTarget===!0)&&(Vt=i.toneMapping);const Ze={shaderID:ce,shaderType:_.type,shaderName:_.name,vertexShader:$,fragmentShader:te,defines:_.defines,customVertexShaderID:me,customFragmentShaderID:he,isRawShaderMaterial:_.isRawShaderMaterial===!0,glslVersion:_.glslVersion,precision:g,batching:Ge,batchingColor:Ge&&q._colorsTexture!==null,instancing:Se,instancingColor:Se&&q.instanceColor!==null,instancingMorph:Se&&q.morphTexture!==null,supportsVertexTextures:m,outputColorSpace:Te===null?i.outputColorSpace:Te.isXRRenderTarget===!0?Te.texture.colorSpace:bt,alphaToCoverage:!!_.alphaToCoverage,map:qe,matcap:ze,envMap:D,envMapMode:D&&K.mapping,envMapCubeUVHeight:re,aoMap:Ct,lightMap:He,bumpMap:We,normalMap:we,displacementMap:m&&je,emissiveMap:Ee,normalMapObjectSpace:we&&_.normalMapType===ep,normalMapTangentSpace:we&&_.normalMapType===sd,metalnessMap:w,roughnessMap:M,anisotropy:A,anisotropyMap:G,clearcoat:x,clearcoatMap:ye,clearcoatNormalMap:Q,clearcoatRoughnessMap:ae,dispersion:L,iridescence:F,iridescenceMap:Ae,iridescenceThicknessMap:be,sheen:Z,sheenColorMap:fe,sheenRoughnessMap:Ue,specularMap:Ie,specularColorMap:st,specularIntensityMap:U,transmission:k,transmissionMap:ue,thicknessMap:Y,gradientMap:J,opaque:_.transparent===!1&&_.blending===rs&&_.alphaToCoverage===!1,alphaMap:oe,alphaTest:de,alphaHash:Ye,combine:_.combine,mapUv:qe&&p(_.map.channel),aoMapUv:Ct&&p(_.aoMap.channel),lightMapUv:He&&p(_.lightMap.channel),bumpMapUv:We&&p(_.bumpMap.channel),normalMapUv:we&&p(_.normalMap.channel),displacementMapUv:je&&p(_.displacementMap.channel),emissiveMapUv:Ee&&p(_.emissiveMap.channel),metalnessMapUv:w&&p(_.metalnessMap.channel),roughnessMapUv:M&&p(_.roughnessMap.channel),anisotropyMapUv:G&&p(_.anisotropyMap.channel),clearcoatMapUv:ye&&p(_.clearcoatMap.channel),clearcoatNormalMapUv:Q&&p(_.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ae&&p(_.clearcoatRoughnessMap.channel),iridescenceMapUv:Ae&&p(_.iridescenceMap.channel),iridescenceThicknessMapUv:be&&p(_.iridescenceThicknessMap.channel),sheenColorMapUv:fe&&p(_.sheenColorMap.channel),sheenRoughnessMapUv:Ue&&p(_.sheenRoughnessMap.channel),specularMapUv:Ie&&p(_.specularMap.channel),specularColorMapUv:st&&p(_.specularColorMap.channel),specularIntensityMapUv:U&&p(_.specularIntensityMap.channel),transmissionMapUv:ue&&p(_.transmissionMap.channel),thicknessMapUv:Y&&p(_.thicknessMap.channel),alphaMapUv:oe&&p(_.alphaMap.channel),vertexTangents:!!X.attributes.tangent&&(we||A),vertexColors:_.vertexColors,vertexAlphas:_.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,pointsUvs:q.isPoints===!0&&!!X.attributes.uv&&(qe||oe),fog:!!ee,useFog:_.fog===!0,fogExp2:!!ee&&ee.isFogExp2,flatShading:_.flatShading===!0,sizeAttenuation:_.sizeAttenuation===!0,logarithmicDepthBuffer:u,reverseDepthBuffer:d,skinning:q.isSkinnedMesh===!0,morphTargets:X.morphAttributes.position!==void 0,morphNormals:X.morphAttributes.normal!==void 0,morphColors:X.morphAttributes.color!==void 0,morphTargetsCount:Xe,morphTextureStride:$e,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:_.dithering,shadowMapEnabled:i.shadowMap.enabled&&W.length>0,shadowMapType:i.shadowMap.type,toneMapping:Vt,decodeVideoTexture:qe&&_.map.isVideoTexture===!0&&Ke.getTransfer(_.map.colorSpace)===at,premultipliedAlpha:_.premultipliedAlpha,doubleSided:_.side===sn,flipSided:_.side===Xt,useDepthPacking:_.depthPacking>=0,depthPacking:_.depthPacking||0,index0AttributeName:_.index0AttributeName,extensionClipCullDistance:pt&&_.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(pt&&_.extensions.multiDraw===!0||Ge)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:_.customProgramCacheKey()};return Ze.vertexUv1s=c.has(1),Ze.vertexUv2s=c.has(2),Ze.vertexUv3s=c.has(3),c.clear(),Ze}function b(_){const E=[];if(_.shaderID?E.push(_.shaderID):(E.push(_.customVertexShaderID),E.push(_.customFragmentShaderID)),_.defines!==void 0)for(const W in _.defines)E.push(W),E.push(_.defines[W]);return _.isRawShaderMaterial===!1&&(S(E,_),T(E,_),E.push(i.outputColorSpace)),E.push(_.customProgramCacheKey),E.join()}function S(_,E){_.push(E.precision),_.push(E.outputColorSpace),_.push(E.envMapMode),_.push(E.envMapCubeUVHeight),_.push(E.mapUv),_.push(E.alphaMapUv),_.push(E.lightMapUv),_.push(E.aoMapUv),_.push(E.bumpMapUv),_.push(E.normalMapUv),_.push(E.displacementMapUv),_.push(E.emissiveMapUv),_.push(E.metalnessMapUv),_.push(E.roughnessMapUv),_.push(E.anisotropyMapUv),_.push(E.clearcoatMapUv),_.push(E.clearcoatNormalMapUv),_.push(E.clearcoatRoughnessMapUv),_.push(E.iridescenceMapUv),_.push(E.iridescenceThicknessMapUv),_.push(E.sheenColorMapUv),_.push(E.sheenRoughnessMapUv),_.push(E.specularMapUv),_.push(E.specularColorMapUv),_.push(E.specularIntensityMapUv),_.push(E.transmissionMapUv),_.push(E.thicknessMapUv),_.push(E.combine),_.push(E.fogExp2),_.push(E.sizeAttenuation),_.push(E.morphTargetsCount),_.push(E.morphAttributeCount),_.push(E.numDirLights),_.push(E.numPointLights),_.push(E.numSpotLights),_.push(E.numSpotLightMaps),_.push(E.numHemiLights),_.push(E.numRectAreaLights),_.push(E.numDirLightShadows),_.push(E.numPointLightShadows),_.push(E.numSpotLightShadows),_.push(E.numSpotLightShadowsWithMaps),_.push(E.numLightProbes),_.push(E.shadowMapType),_.push(E.toneMapping),_.push(E.numClippingPlanes),_.push(E.numClipIntersection),_.push(E.depthPacking)}function T(_,E){o.disableAll(),E.supportsVertexTextures&&o.enable(0),E.instancing&&o.enable(1),E.instancingColor&&o.enable(2),E.instancingMorph&&o.enable(3),E.matcap&&o.enable(4),E.envMap&&o.enable(5),E.normalMapObjectSpace&&o.enable(6),E.normalMapTangentSpace&&o.enable(7),E.clearcoat&&o.enable(8),E.iridescence&&o.enable(9),E.alphaTest&&o.enable(10),E.vertexColors&&o.enable(11),E.vertexAlphas&&o.enable(12),E.vertexUv1s&&o.enable(13),E.vertexUv2s&&o.enable(14),E.vertexUv3s&&o.enable(15),E.vertexTangents&&o.enable(16),E.anisotropy&&o.enable(17),E.alphaHash&&o.enable(18),E.batching&&o.enable(19),E.dispersion&&o.enable(20),E.batchingColor&&o.enable(21),_.push(o.mask),o.disableAll(),E.fog&&o.enable(0),E.useFog&&o.enable(1),E.flatShading&&o.enable(2),E.logarithmicDepthBuffer&&o.enable(3),E.reverseDepthBuffer&&o.enable(4),E.skinning&&o.enable(5),E.morphTargets&&o.enable(6),E.morphNormals&&o.enable(7),E.morphColors&&o.enable(8),E.premultipliedAlpha&&o.enable(9),E.shadowMapEnabled&&o.enable(10),E.doubleSided&&o.enable(11),E.flipSided&&o.enable(12),E.useDepthPacking&&o.enable(13),E.dithering&&o.enable(14),E.transmission&&o.enable(15),E.sheen&&o.enable(16),E.opaque&&o.enable(17),E.pointsUvs&&o.enable(18),E.decodeVideoTexture&&o.enable(19),E.alphaToCoverage&&o.enable(20),_.push(o.mask)}function P(_){const E=v[_.type];let W;if(E){const V=yn[E];W=Ca.clone(V.uniforms)}else W=_.uniforms;return W}function R(_,E){let W;for(let V=0,q=h.length;V<q;V++){const ee=h[V];if(ee.cacheKey===E){W=ee,++W.usedTimes;break}}return W===void 0&&(W=new iv(i,E,_,r),h.push(W)),W}function C(_){if(--_.usedTimes===0){const E=h.indexOf(_);h[E]=h[h.length-1],h.pop(),_.destroy()}}function O(_){l.remove(_)}function j(){l.dispose()}return{getParameters:f,getProgramCacheKey:b,getUniforms:P,acquireProgram:R,releaseProgram:C,releaseShaderCache:O,programs:h,dispose:j}}function lv(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function cv(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Uh(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Nh(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(u,d,m,g,v,p){let f=i[e];return f===void 0?(f={id:u.id,object:u,geometry:d,material:m,groupOrder:g,renderOrder:u.renderOrder,z:v,group:p},i[e]=f):(f.id=u.id,f.object=u,f.geometry=d,f.material=m,f.groupOrder=g,f.renderOrder=u.renderOrder,f.z=v,f.group=p),e++,f}function o(u,d,m,g,v,p){const f=a(u,d,m,g,v,p);m.transmission>0?n.push(f):m.transparent===!0?s.push(f):t.push(f)}function l(u,d,m,g,v,p){const f=a(u,d,m,g,v,p);m.transmission>0?n.unshift(f):m.transparent===!0?s.unshift(f):t.unshift(f)}function c(u,d){t.length>1&&t.sort(u||cv),n.length>1&&n.sort(d||Uh),s.length>1&&s.sort(d||Uh)}function h(){for(let u=e,d=i.length;u<d;u++){const m=i[u];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:o,unshift:l,finish:h,sort:c}}function hv(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new Nh,i.set(n,[a])):s>=r.length?(a=new Nh,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function uv(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new I,color:new ve};break;case"SpotLight":t={position:new I,direction:new I,color:new ve,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new I,color:new ve,distance:0,decay:0};break;case"HemisphereLight":t={direction:new I,skyColor:new ve,groundColor:new ve};break;case"RectAreaLight":t={color:new ve,position:new I,halfWidth:new I,halfHeight:new I};break}return i[e.id]=t,t}}}function dv(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ce};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ce};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ce,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let fv=0;function pv(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function mv(i){const e=new uv,t=dv(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new I);const s=new I,r=new Pe,a=new Pe;function o(c){let h=0,u=0,d=0;for(let j=0;j<9;j++)n.probe[j].set(0,0,0);let m=0,g=0,v=0,p=0,f=0,b=0,S=0,T=0,P=0,R=0,C=0;c.sort(pv);for(let j=0,_=c.length;j<_;j++){const E=c[j],W=E.color,V=E.intensity,q=E.distance,ee=E.shadow&&E.shadow.map?E.shadow.map.texture:null;if(E.isAmbientLight)h+=W.r*V,u+=W.g*V,d+=W.b*V;else if(E.isLightProbe){for(let X=0;X<9;X++)n.probe[X].addScaledVector(E.sh.coefficients[X],V);C++}else if(E.isDirectionalLight){const X=e.get(E);if(X.color.copy(E.color).multiplyScalar(E.intensity),E.castShadow){const ne=E.shadow,K=t.get(E);K.shadowIntensity=ne.intensity,K.shadowBias=ne.bias,K.shadowNormalBias=ne.normalBias,K.shadowRadius=ne.radius,K.shadowMapSize=ne.mapSize,n.directionalShadow[m]=K,n.directionalShadowMap[m]=ee,n.directionalShadowMatrix[m]=E.shadow.matrix,b++}n.directional[m]=X,m++}else if(E.isSpotLight){const X=e.get(E);X.position.setFromMatrixPosition(E.matrixWorld),X.color.copy(W).multiplyScalar(V),X.distance=q,X.coneCos=Math.cos(E.angle),X.penumbraCos=Math.cos(E.angle*(1-E.penumbra)),X.decay=E.decay,n.spot[v]=X;const ne=E.shadow;if(E.map&&(n.spotLightMap[P]=E.map,P++,ne.updateMatrices(E),E.castShadow&&R++),n.spotLightMatrix[v]=ne.matrix,E.castShadow){const K=t.get(E);K.shadowIntensity=ne.intensity,K.shadowBias=ne.bias,K.shadowNormalBias=ne.normalBias,K.shadowRadius=ne.radius,K.shadowMapSize=ne.mapSize,n.spotShadow[v]=K,n.spotShadowMap[v]=ee,T++}v++}else if(E.isRectAreaLight){const X=e.get(E);X.color.copy(W).multiplyScalar(V),X.halfWidth.set(E.width*.5,0,0),X.halfHeight.set(0,E.height*.5,0),n.rectArea[p]=X,p++}else if(E.isPointLight){const X=e.get(E);if(X.color.copy(E.color).multiplyScalar(E.intensity),X.distance=E.distance,X.decay=E.decay,E.castShadow){const ne=E.shadow,K=t.get(E);K.shadowIntensity=ne.intensity,K.shadowBias=ne.bias,K.shadowNormalBias=ne.normalBias,K.shadowRadius=ne.radius,K.shadowMapSize=ne.mapSize,K.shadowCameraNear=ne.camera.near,K.shadowCameraFar=ne.camera.far,n.pointShadow[g]=K,n.pointShadowMap[g]=ee,n.pointShadowMatrix[g]=E.shadow.matrix,S++}n.point[g]=X,g++}else if(E.isHemisphereLight){const X=e.get(E);X.skyColor.copy(E.color).multiplyScalar(V),X.groundColor.copy(E.groundColor).multiplyScalar(V),n.hemi[f]=X,f++}}p>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=se.LTC_FLOAT_1,n.rectAreaLTC2=se.LTC_FLOAT_2):(n.rectAreaLTC1=se.LTC_HALF_1,n.rectAreaLTC2=se.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;const O=n.hash;(O.directionalLength!==m||O.pointLength!==g||O.spotLength!==v||O.rectAreaLength!==p||O.hemiLength!==f||O.numDirectionalShadows!==b||O.numPointShadows!==S||O.numSpotShadows!==T||O.numSpotMaps!==P||O.numLightProbes!==C)&&(n.directional.length=m,n.spot.length=v,n.rectArea.length=p,n.point.length=g,n.hemi.length=f,n.directionalShadow.length=b,n.directionalShadowMap.length=b,n.pointShadow.length=S,n.pointShadowMap.length=S,n.spotShadow.length=T,n.spotShadowMap.length=T,n.directionalShadowMatrix.length=b,n.pointShadowMatrix.length=S,n.spotLightMatrix.length=T+P-R,n.spotLightMap.length=P,n.numSpotLightShadowsWithMaps=R,n.numLightProbes=C,O.directionalLength=m,O.pointLength=g,O.spotLength=v,O.rectAreaLength=p,O.hemiLength=f,O.numDirectionalShadows=b,O.numPointShadows=S,O.numSpotShadows=T,O.numSpotMaps=P,O.numLightProbes=C,n.version=fv++)}function l(c,h){let u=0,d=0,m=0,g=0,v=0;const p=h.matrixWorldInverse;for(let f=0,b=c.length;f<b;f++){const S=c[f];if(S.isDirectionalLight){const T=n.directional[u];T.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),T.direction.sub(s),T.direction.transformDirection(p),u++}else if(S.isSpotLight){const T=n.spot[m];T.position.setFromMatrixPosition(S.matrixWorld),T.position.applyMatrix4(p),T.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),T.direction.sub(s),T.direction.transformDirection(p),m++}else if(S.isRectAreaLight){const T=n.rectArea[g];T.position.setFromMatrixPosition(S.matrixWorld),T.position.applyMatrix4(p),a.identity(),r.copy(S.matrixWorld),r.premultiply(p),a.extractRotation(r),T.halfWidth.set(S.width*.5,0,0),T.halfHeight.set(0,S.height*.5,0),T.halfWidth.applyMatrix4(a),T.halfHeight.applyMatrix4(a),g++}else if(S.isPointLight){const T=n.point[d];T.position.setFromMatrixPosition(S.matrixWorld),T.position.applyMatrix4(p),d++}else if(S.isHemisphereLight){const T=n.hemi[v];T.direction.setFromMatrixPosition(S.matrixWorld),T.direction.transformDirection(p),v++}}}return{setup:o,setupView:l,state:n}}function Fh(i){const e=new mv(i),t=[],n=[];function s(h){c.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function a(h){n.push(h)}function o(){e.setup(t)}function l(h){e.setupView(t,h)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:o,setupLightsView:l,pushLight:r,pushShadow:a}}function gv(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new Fh(i),e.set(s,[o])):r>=a.length?(o=new Fh(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}class yd extends Sn{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Qf,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class _v extends Sn{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const vv=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Mv(i,e,t){let n=new rc;const s=new Ce,r=new Ce,a=new Je,o=new yd({depthPacking:id}),l=new _v,c={},h=t.maxTextureSize,u={[Gn]:Xt,[Xt]:Gn,[sn]:sn},d=new Ut({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ce},radius:{value:4}},vertexShader:vv,fragmentShader:xv}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const g=new Zt;g.setAttribute("position",new Ht(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new dt(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ql;let f=this.type;this.render=function(R,C,O){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||R.length===0)return;const j=i.getRenderTarget(),_=i.getActiveCubeFace(),E=i.getActiveMipmapLevel(),W=i.state;W.setBlending(_n),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const V=f!==Un&&this.type===Un,q=f===Un&&this.type!==Un;for(let ee=0,X=R.length;ee<X;ee++){const ne=R[ee],K=ne.shadow;if(K===void 0){console.warn("THREE.WebGLShadowMap:",ne,"has no shadow.");continue}if(K.autoUpdate===!1&&K.needsUpdate===!1)continue;s.copy(K.mapSize);const re=K.getFrameExtents();if(s.multiply(re),r.copy(K.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/re.x),s.x=r.x*re.x,K.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/re.y),s.y=r.y*re.y,K.mapSize.y=r.y)),K.map===null||V===!0||q===!0){const pe=this.type!==Un?{minFilter:kt,magFilter:kt}:{};K.map!==null&&K.map.dispose(),K.map=new Bt(s.x,s.y,pe),K.map.texture.name=ne.name+".shadowMap",K.camera.updateProjectionMatrix()}i.setRenderTarget(K.map),i.clear();const ce=K.getViewportCount();for(let pe=0;pe<ce;pe++){const Xe=K.getViewport(pe);a.set(r.x*Xe.x,r.y*Xe.y,r.x*Xe.z,r.y*Xe.w),W.viewport(a),K.updateMatrices(ne,pe),n=K.getFrustum(),T(C,O,K.camera,ne,this.type)}K.isPointLightShadow!==!0&&this.type===Un&&b(K,O),K.needsUpdate=!1}f=this.type,p.needsUpdate=!1,i.setRenderTarget(j,_,E)};function b(R,C){const O=e.update(v);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Bt(s.x,s.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(C,null,O,d,v,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(C,null,O,m,v,null)}function S(R,C,O,j){let _=null;const E=O.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(E!==void 0)_=E;else if(_=O.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const W=_.uuid,V=C.uuid;let q=c[W];q===void 0&&(q={},c[W]=q);let ee=q[V];ee===void 0&&(ee=_.clone(),q[V]=ee,C.addEventListener("dispose",P)),_=ee}if(_.visible=C.visible,_.wireframe=C.wireframe,j===Un?_.side=C.shadowSide!==null?C.shadowSide:C.side:_.side=C.shadowSide!==null?C.shadowSide:u[C.side],_.alphaMap=C.alphaMap,_.alphaTest=C.alphaTest,_.map=C.map,_.clipShadows=C.clipShadows,_.clippingPlanes=C.clippingPlanes,_.clipIntersection=C.clipIntersection,_.displacementMap=C.displacementMap,_.displacementScale=C.displacementScale,_.displacementBias=C.displacementBias,_.wireframeLinewidth=C.wireframeLinewidth,_.linewidth=C.linewidth,O.isPointLight===!0&&_.isMeshDistanceMaterial===!0){const W=i.properties.get(_);W.light=O}return _}function T(R,C,O,j,_){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&_===Un)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,R.matrixWorld);const V=e.update(R),q=R.material;if(Array.isArray(q)){const ee=V.groups;for(let X=0,ne=ee.length;X<ne;X++){const K=ee[X],re=q[K.materialIndex];if(re&&re.visible){const ce=S(R,re,j,_);R.onBeforeShadow(i,R,C,O,V,ce,K),i.renderBufferDirect(O,null,V,ce,R,K),R.onAfterShadow(i,R,C,O,V,ce,K)}}}else if(q.visible){const ee=S(R,q,j,_);R.onBeforeShadow(i,R,C,O,V,ee,null),i.renderBufferDirect(O,null,V,ee,R,null),R.onAfterShadow(i,R,C,O,V,ee,null)}}const W=R.children;for(let V=0,q=W.length;V<q;V++)T(W[V],C,O,j,_)}function P(R){R.target.removeEventListener("dispose",P);for(const O in c){const j=c[O],_=R.target.uuid;_ in j&&(j[_].dispose(),delete j[_])}}}const yv={[Fo]:Oo,[Bo]:Ho,[ko]:Vo,[ps]:zo,[Oo]:Fo,[Ho]:Bo,[Vo]:ko,[zo]:ps};function Sv(i){function e(){let U=!1;const ue=new Je;let Y=null;const J=new Je(0,0,0,0);return{setMask:function(oe){Y!==oe&&!U&&(i.colorMask(oe,oe,oe,oe),Y=oe)},setLocked:function(oe){U=oe},setClear:function(oe,de,Ye,pt,Vt){Vt===!0&&(oe*=pt,de*=pt,Ye*=pt),ue.set(oe,de,Ye,pt),J.equals(ue)===!1&&(i.clearColor(oe,de,Ye,pt),J.copy(ue))},reset:function(){U=!1,Y=null,J.set(-1,0,0,0)}}}function t(){let U=!1,ue=!1,Y=null,J=null,oe=null;return{setReversed:function(de){ue=de},setTest:function(de){de?me(i.DEPTH_TEST):he(i.DEPTH_TEST)},setMask:function(de){Y!==de&&!U&&(i.depthMask(de),Y=de)},setFunc:function(de){if(ue&&(de=yv[de]),J!==de){switch(de){case Fo:i.depthFunc(i.NEVER);break;case Oo:i.depthFunc(i.ALWAYS);break;case Bo:i.depthFunc(i.LESS);break;case ps:i.depthFunc(i.LEQUAL);break;case ko:i.depthFunc(i.EQUAL);break;case zo:i.depthFunc(i.GEQUAL);break;case Ho:i.depthFunc(i.GREATER);break;case Vo:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}J=de}},setLocked:function(de){U=de},setClear:function(de){oe!==de&&(i.clearDepth(de),oe=de)},reset:function(){U=!1,Y=null,J=null,oe=null}}}function n(){let U=!1,ue=null,Y=null,J=null,oe=null,de=null,Ye=null,pt=null,Vt=null;return{setTest:function(Ze){U||(Ze?me(i.STENCIL_TEST):he(i.STENCIL_TEST))},setMask:function(Ze){ue!==Ze&&!U&&(i.stencilMask(Ze),ue=Ze)},setFunc:function(Ze,Gt,wn){(Y!==Ze||J!==Gt||oe!==wn)&&(i.stencilFunc(Ze,Gt,wn),Y=Ze,J=Gt,oe=wn)},setOp:function(Ze,Gt,wn){(de!==Ze||Ye!==Gt||pt!==wn)&&(i.stencilOp(Ze,Gt,wn),de=Ze,Ye=Gt,pt=wn)},setLocked:function(Ze){U=Ze},setClear:function(Ze){Vt!==Ze&&(i.clearStencil(Ze),Vt=Ze)},reset:function(){U=!1,ue=null,Y=null,J=null,oe=null,de=null,Ye=null,pt=null,Vt=null}}}const s=new e,r=new t,a=new n,o=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,d=[],m=null,g=!1,v=null,p=null,f=null,b=null,S=null,T=null,P=null,R=new ve(0,0,0),C=0,O=!1,j=null,_=null,E=null,W=null,V=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ee=!1,X=0;const ne=i.getParameter(i.VERSION);ne.indexOf("WebGL")!==-1?(X=parseFloat(/^WebGL (\d)/.exec(ne)[1]),ee=X>=1):ne.indexOf("OpenGL ES")!==-1&&(X=parseFloat(/^OpenGL ES (\d)/.exec(ne)[1]),ee=X>=2);let K=null,re={};const ce=i.getParameter(i.SCISSOR_BOX),pe=i.getParameter(i.VIEWPORT),Xe=new Je().fromArray(ce),$e=new Je().fromArray(pe);function $(U,ue,Y,J){const oe=new Uint8Array(4),de=i.createTexture();i.bindTexture(U,de),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ye=0;Ye<Y;Ye++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(ue,0,i.RGBA,1,1,J,0,i.RGBA,i.UNSIGNED_BYTE,oe):i.texImage2D(ue+Ye,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,oe);return de}const te={};te[i.TEXTURE_2D]=$(i.TEXTURE_2D,i.TEXTURE_2D,1),te[i.TEXTURE_CUBE_MAP]=$(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),te[i.TEXTURE_2D_ARRAY]=$(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),te[i.TEXTURE_3D]=$(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),a.setClear(0),me(i.DEPTH_TEST),r.setFunc(ps),He(!1),We(Wc),me(i.CULL_FACE),D(_n);function me(U){c[U]!==!0&&(i.enable(U),c[U]=!0)}function he(U){c[U]!==!1&&(i.disable(U),c[U]=!1)}function Te(U,ue){return h[U]!==ue?(i.bindFramebuffer(U,ue),h[U]=ue,U===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ue),U===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ue),!0):!1}function Se(U,ue){let Y=d,J=!1;if(U){Y=u.get(ue),Y===void 0&&(Y=[],u.set(ue,Y));const oe=U.textures;if(Y.length!==oe.length||Y[0]!==i.COLOR_ATTACHMENT0){for(let de=0,Ye=oe.length;de<Ye;de++)Y[de]=i.COLOR_ATTACHMENT0+de;Y.length=oe.length,J=!0}}else Y[0]!==i.BACK&&(Y[0]=i.BACK,J=!0);J&&i.drawBuffers(Y)}function Ge(U){return m!==U?(i.useProgram(U),m=U,!0):!1}const qe={[wi]:i.FUNC_ADD,[Af]:i.FUNC_SUBTRACT,[Rf]:i.FUNC_REVERSE_SUBTRACT};qe[Cf]=i.MIN,qe[Lf]=i.MAX;const ze={[If]:i.ZERO,[Pf]:i.ONE,[Df]:i.SRC_COLOR,[Uo]:i.SRC_ALPHA,[kf]:i.SRC_ALPHA_SATURATE,[Of]:i.DST_COLOR,[Nf]:i.DST_ALPHA,[Uf]:i.ONE_MINUS_SRC_COLOR,[No]:i.ONE_MINUS_SRC_ALPHA,[Bf]:i.ONE_MINUS_DST_COLOR,[Ff]:i.ONE_MINUS_DST_ALPHA,[zf]:i.CONSTANT_COLOR,[Hf]:i.ONE_MINUS_CONSTANT_COLOR,[Vf]:i.CONSTANT_ALPHA,[Gf]:i.ONE_MINUS_CONSTANT_ALPHA};function D(U,ue,Y,J,oe,de,Ye,pt,Vt,Ze){if(U===_n){g===!0&&(he(i.BLEND),g=!1);return}if(g===!1&&(me(i.BLEND),g=!0),U!==wf){if(U!==v||Ze!==O){if((p!==wi||S!==wi)&&(i.blendEquation(i.FUNC_ADD),p=wi,S=wi),Ze)switch(U){case rs:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Do:i.blendFunc(i.ONE,i.ONE);break;case Xc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case qc:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case rs:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Do:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Xc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case qc:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}f=null,b=null,T=null,P=null,R.set(0,0,0),C=0,v=U,O=Ze}return}oe=oe||ue,de=de||Y,Ye=Ye||J,(ue!==p||oe!==S)&&(i.blendEquationSeparate(qe[ue],qe[oe]),p=ue,S=oe),(Y!==f||J!==b||de!==T||Ye!==P)&&(i.blendFuncSeparate(ze[Y],ze[J],ze[de],ze[Ye]),f=Y,b=J,T=de,P=Ye),(pt.equals(R)===!1||Vt!==C)&&(i.blendColor(pt.r,pt.g,pt.b,Vt),R.copy(pt),C=Vt),v=U,O=!1}function Ct(U,ue){U.side===sn?he(i.CULL_FACE):me(i.CULL_FACE);let Y=U.side===Xt;ue&&(Y=!Y),He(Y),U.blending===rs&&U.transparent===!1?D(_n):D(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),r.setFunc(U.depthFunc),r.setTest(U.depthTest),r.setMask(U.depthWrite),s.setMask(U.colorWrite);const J=U.stencilWrite;a.setTest(J),J&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),je(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?me(i.SAMPLE_ALPHA_TO_COVERAGE):he(i.SAMPLE_ALPHA_TO_COVERAGE)}function He(U){j!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),j=U)}function We(U){U!==bf?(me(i.CULL_FACE),U!==_&&(U===Wc?i.cullFace(i.BACK):U===Tf?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):he(i.CULL_FACE),_=U}function we(U){U!==E&&(ee&&i.lineWidth(U),E=U)}function je(U,ue,Y){U?(me(i.POLYGON_OFFSET_FILL),(W!==ue||V!==Y)&&(i.polygonOffset(ue,Y),W=ue,V=Y)):he(i.POLYGON_OFFSET_FILL)}function Ee(U){U?me(i.SCISSOR_TEST):he(i.SCISSOR_TEST)}function w(U){U===void 0&&(U=i.TEXTURE0+q-1),K!==U&&(i.activeTexture(U),K=U)}function M(U,ue,Y){Y===void 0&&(K===null?Y=i.TEXTURE0+q-1:Y=K);let J=re[Y];J===void 0&&(J={type:void 0,texture:void 0},re[Y]=J),(J.type!==U||J.texture!==ue)&&(K!==Y&&(i.activeTexture(Y),K=Y),i.bindTexture(U,ue||te[U]),J.type=U,J.texture=ue)}function A(){const U=re[K];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function x(){try{i.compressedTexImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function L(){try{i.compressedTexImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function F(){try{i.texSubImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Z(){try{i.texSubImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function k(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function G(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ye(){try{i.texStorage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Q(){try{i.texStorage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ae(){try{i.texImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ae(){try{i.texImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function be(U){Xe.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),Xe.copy(U))}function fe(U){$e.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),$e.copy(U))}function Ue(U,ue){let Y=l.get(ue);Y===void 0&&(Y=new WeakMap,l.set(ue,Y));let J=Y.get(U);J===void 0&&(J=i.getUniformBlockIndex(ue,U.name),Y.set(U,J))}function Ie(U,ue){const J=l.get(ue).get(U);o.get(ue)!==J&&(i.uniformBlockBinding(ue,J,U.__bindingPointIndex),o.set(ue,J))}function st(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},K=null,re={},h={},u=new WeakMap,d=[],m=null,g=!1,v=null,p=null,f=null,b=null,S=null,T=null,P=null,R=new ve(0,0,0),C=0,O=!1,j=null,_=null,E=null,W=null,V=null,Xe.set(0,0,i.canvas.width,i.canvas.height),$e.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),a.reset()}return{buffers:{color:s,depth:r,stencil:a},enable:me,disable:he,bindFramebuffer:Te,drawBuffers:Se,useProgram:Ge,setBlending:D,setMaterial:Ct,setFlipSided:He,setCullFace:We,setLineWidth:we,setPolygonOffset:je,setScissorTest:Ee,activeTexture:w,bindTexture:M,unbindTexture:A,compressedTexImage2D:x,compressedTexImage3D:L,texImage2D:ae,texImage3D:Ae,updateUBOMapping:Ue,uniformBlockBinding:Ie,texStorage2D:ye,texStorage3D:Q,texSubImage2D:F,texSubImage3D:Z,compressedTexSubImage2D:k,compressedTexSubImage3D:G,scissor:be,viewport:fe,reset:st}}function Oh(i,e,t,n){const s=Ev(n);switch(t){case $u:return i*e;case Ju:return i*e;case Qu:return i*e*2;case Zl:return i*e/s.components*s.byteLength;case Jl:return i*e/s.components*s.byteLength;case ed:return i*e*2/s.components*s.byteLength;case Ql:return i*e*2/s.components*s.byteLength;case Zu:return i*e*3/s.components*s.byteLength;case an:return i*e*4/s.components*s.byteLength;case ec:return i*e*4/s.components*s.byteLength;case $r:case Zr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Jr:case Qr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case qo:case Yo:return Math.max(i,16)*Math.max(e,8)/4;case Xo:case jo:return Math.max(i,8)*Math.max(e,8)/2;case Ko:case $o:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Zo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Jo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Qo:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case el:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case tl:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case nl:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case il:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case sl:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case rl:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case al:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case ol:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case ll:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case cl:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case hl:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case ul:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case ea:case dl:case fl:return Math.ceil(i/4)*Math.ceil(e/4)*16;case td:case pl:return Math.ceil(i/4)*Math.ceil(e/4)*8;case ml:case gl:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Ev(i){switch(i){case Wn:case ju:return{byteLength:1,components:1};case sr:case Yu:case nn:return{byteLength:2,components:1};case Kl:case $l:return{byteLength:2,components:4};case Ni:case Yl:case gn:return{byteLength:4,components:1};case Ku:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function bv(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ce,h=new WeakMap;let u;const d=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,M){return m?new OffscreenCanvas(w,M):or("canvas")}function v(w,M,A){let x=1;const L=Ee(w);if((L.width>A||L.height>A)&&(x=A/Math.max(L.width,L.height)),x<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const F=Math.floor(x*L.width),Z=Math.floor(x*L.height);u===void 0&&(u=g(F,Z));const k=M?g(F,Z):u;return k.width=F,k.height=Z,k.getContext("2d").drawImage(w,0,0,F,Z),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+L.width+"x"+L.height+") to ("+F+"x"+Z+")."),k}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+L.width+"x"+L.height+")."),w;return w}function p(w){return w.generateMipmaps&&w.minFilter!==kt&&w.minFilter!==$t}function f(w){i.generateMipmap(w)}function b(w,M,A,x,L=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let F=M;if(M===i.RED&&(A===i.FLOAT&&(F=i.R32F),A===i.HALF_FLOAT&&(F=i.R16F),A===i.UNSIGNED_BYTE&&(F=i.R8)),M===i.RED_INTEGER&&(A===i.UNSIGNED_BYTE&&(F=i.R8UI),A===i.UNSIGNED_SHORT&&(F=i.R16UI),A===i.UNSIGNED_INT&&(F=i.R32UI),A===i.BYTE&&(F=i.R8I),A===i.SHORT&&(F=i.R16I),A===i.INT&&(F=i.R32I)),M===i.RG&&(A===i.FLOAT&&(F=i.RG32F),A===i.HALF_FLOAT&&(F=i.RG16F),A===i.UNSIGNED_BYTE&&(F=i.RG8)),M===i.RG_INTEGER&&(A===i.UNSIGNED_BYTE&&(F=i.RG8UI),A===i.UNSIGNED_SHORT&&(F=i.RG16UI),A===i.UNSIGNED_INT&&(F=i.RG32UI),A===i.BYTE&&(F=i.RG8I),A===i.SHORT&&(F=i.RG16I),A===i.INT&&(F=i.RG32I)),M===i.RGB_INTEGER&&(A===i.UNSIGNED_BYTE&&(F=i.RGB8UI),A===i.UNSIGNED_SHORT&&(F=i.RGB16UI),A===i.UNSIGNED_INT&&(F=i.RGB32UI),A===i.BYTE&&(F=i.RGB8I),A===i.SHORT&&(F=i.RGB16I),A===i.INT&&(F=i.RGB32I)),M===i.RGBA_INTEGER&&(A===i.UNSIGNED_BYTE&&(F=i.RGBA8UI),A===i.UNSIGNED_SHORT&&(F=i.RGBA16UI),A===i.UNSIGNED_INT&&(F=i.RGBA32UI),A===i.BYTE&&(F=i.RGBA8I),A===i.SHORT&&(F=i.RGBA16I),A===i.INT&&(F=i.RGBA32I)),M===i.RGB&&A===i.UNSIGNED_INT_5_9_9_9_REV&&(F=i.RGB9_E5),M===i.RGBA){const Z=L?ha:Ke.getTransfer(x);A===i.FLOAT&&(F=i.RGBA32F),A===i.HALF_FLOAT&&(F=i.RGBA16F),A===i.UNSIGNED_BYTE&&(F=Z===at?i.SRGB8_ALPHA8:i.RGBA8),A===i.UNSIGNED_SHORT_4_4_4_4&&(F=i.RGBA4),A===i.UNSIGNED_SHORT_5_5_5_1&&(F=i.RGB5_A1)}return(F===i.R16F||F===i.R32F||F===i.RG16F||F===i.RG32F||F===i.RGBA16F||F===i.RGBA32F)&&e.get("EXT_color_buffer_float"),F}function S(w,M){let A;return w?M===null||M===Ni||M===_s?A=i.DEPTH24_STENCIL8:M===gn?A=i.DEPTH32F_STENCIL8:M===sr&&(A=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Ni||M===_s?A=i.DEPTH_COMPONENT24:M===gn?A=i.DEPTH_COMPONENT32F:M===sr&&(A=i.DEPTH_COMPONENT16),A}function T(w,M){return p(w)===!0||w.isFramebufferTexture&&w.minFilter!==kt&&w.minFilter!==$t?Math.log2(Math.max(M.width,M.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?M.mipmaps.length:1}function P(w){const M=w.target;M.removeEventListener("dispose",P),C(M),M.isVideoTexture&&h.delete(M)}function R(w){const M=w.target;M.removeEventListener("dispose",R),j(M)}function C(w){const M=n.get(w);if(M.__webglInit===void 0)return;const A=w.source,x=d.get(A);if(x){const L=x[M.__cacheKey];L.usedTimes--,L.usedTimes===0&&O(w),Object.keys(x).length===0&&d.delete(A)}n.remove(w)}function O(w){const M=n.get(w);i.deleteTexture(M.__webglTexture);const A=w.source,x=d.get(A);delete x[M.__cacheKey],a.memory.textures--}function j(w){const M=n.get(w);if(w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let x=0;x<6;x++){if(Array.isArray(M.__webglFramebuffer[x]))for(let L=0;L<M.__webglFramebuffer[x].length;L++)i.deleteFramebuffer(M.__webglFramebuffer[x][L]);else i.deleteFramebuffer(M.__webglFramebuffer[x]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[x])}else{if(Array.isArray(M.__webglFramebuffer))for(let x=0;x<M.__webglFramebuffer.length;x++)i.deleteFramebuffer(M.__webglFramebuffer[x]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let x=0;x<M.__webglColorRenderbuffer.length;x++)M.__webglColorRenderbuffer[x]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[x]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const A=w.textures;for(let x=0,L=A.length;x<L;x++){const F=n.get(A[x]);F.__webglTexture&&(i.deleteTexture(F.__webglTexture),a.memory.textures--),n.remove(A[x])}n.remove(w)}let _=0;function E(){_=0}function W(){const w=_;return w>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+s.maxTextures),_+=1,w}function V(w){const M=[];return M.push(w.wrapS),M.push(w.wrapT),M.push(w.wrapR||0),M.push(w.magFilter),M.push(w.minFilter),M.push(w.anisotropy),M.push(w.internalFormat),M.push(w.format),M.push(w.type),M.push(w.generateMipmaps),M.push(w.premultiplyAlpha),M.push(w.flipY),M.push(w.unpackAlignment),M.push(w.colorSpace),M.join()}function q(w,M){const A=n.get(w);if(w.isVideoTexture&&we(w),w.isRenderTargetTexture===!1&&w.version>0&&A.__version!==w.version){const x=w.image;if(x===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(x.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{$e(A,w,M);return}}t.bindTexture(i.TEXTURE_2D,A.__webglTexture,i.TEXTURE0+M)}function ee(w,M){const A=n.get(w);if(w.version>0&&A.__version!==w.version){$e(A,w,M);return}t.bindTexture(i.TEXTURE_2D_ARRAY,A.__webglTexture,i.TEXTURE0+M)}function X(w,M){const A=n.get(w);if(w.version>0&&A.__version!==w.version){$e(A,w,M);return}t.bindTexture(i.TEXTURE_3D,A.__webglTexture,i.TEXTURE0+M)}function ne(w,M){const A=n.get(w);if(w.version>0&&A.__version!==w.version){$(A,w,M);return}t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+M)}const K={[hi]:i.REPEAT,[si]:i.CLAMP_TO_EDGE,[la]:i.MIRRORED_REPEAT},re={[kt]:i.NEAREST,[qu]:i.NEAREST_MIPMAP_NEAREST,[Ys]:i.NEAREST_MIPMAP_LINEAR,[$t]:i.LINEAR,[Kr]:i.LINEAR_MIPMAP_NEAREST,[kn]:i.LINEAR_MIPMAP_LINEAR},ce={[tp]:i.NEVER,[op]:i.ALWAYS,[np]:i.LESS,[rd]:i.LEQUAL,[ip]:i.EQUAL,[ap]:i.GEQUAL,[sp]:i.GREATER,[rp]:i.NOTEQUAL};function pe(w,M){if(M.type===gn&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===$t||M.magFilter===Kr||M.magFilter===Ys||M.magFilter===kn||M.minFilter===$t||M.minFilter===Kr||M.minFilter===Ys||M.minFilter===kn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,K[M.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,K[M.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,K[M.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,re[M.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,re[M.minFilter]),M.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,ce[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===kt||M.minFilter!==Ys&&M.minFilter!==kn||M.type===gn&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const A=e.get("EXT_texture_filter_anisotropic");i.texParameterf(w,A.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function Xe(w,M){let A=!1;w.__webglInit===void 0&&(w.__webglInit=!0,M.addEventListener("dispose",P));const x=M.source;let L=d.get(x);L===void 0&&(L={},d.set(x,L));const F=V(M);if(F!==w.__cacheKey){L[F]===void 0&&(L[F]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,A=!0),L[F].usedTimes++;const Z=L[w.__cacheKey];Z!==void 0&&(L[w.__cacheKey].usedTimes--,Z.usedTimes===0&&O(M)),w.__cacheKey=F,w.__webglTexture=L[F].texture}return A}function $e(w,M,A){let x=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(x=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(x=i.TEXTURE_3D);const L=Xe(w,M),F=M.source;t.bindTexture(x,w.__webglTexture,i.TEXTURE0+A);const Z=n.get(F);if(F.version!==Z.__version||L===!0){t.activeTexture(i.TEXTURE0+A);const k=Ke.getPrimaries(Ke.workingColorSpace),G=M.colorSpace===ii?null:Ke.getPrimaries(M.colorSpace),ye=M.colorSpace===ii||k===G?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye);let Q=v(M.image,!1,s.maxTextureSize);Q=je(M,Q);const ae=r.convert(M.format,M.colorSpace),Ae=r.convert(M.type);let be=b(M.internalFormat,ae,Ae,M.colorSpace,M.isVideoTexture);pe(x,M);let fe;const Ue=M.mipmaps,Ie=M.isVideoTexture!==!0,st=Z.__version===void 0||L===!0,U=F.dataReady,ue=T(M,Q);if(M.isDepthTexture)be=S(M.format===vs,M.type),st&&(Ie?t.texStorage2D(i.TEXTURE_2D,1,be,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,be,Q.width,Q.height,0,ae,Ae,null));else if(M.isDataTexture)if(Ue.length>0){Ie&&st&&t.texStorage2D(i.TEXTURE_2D,ue,be,Ue[0].width,Ue[0].height);for(let Y=0,J=Ue.length;Y<J;Y++)fe=Ue[Y],Ie?U&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,fe.width,fe.height,ae,Ae,fe.data):t.texImage2D(i.TEXTURE_2D,Y,be,fe.width,fe.height,0,ae,Ae,fe.data);M.generateMipmaps=!1}else Ie?(st&&t.texStorage2D(i.TEXTURE_2D,ue,be,Q.width,Q.height),U&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Q.width,Q.height,ae,Ae,Q.data)):t.texImage2D(i.TEXTURE_2D,0,be,Q.width,Q.height,0,ae,Ae,Q.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Ie&&st&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ue,be,Ue[0].width,Ue[0].height,Q.depth);for(let Y=0,J=Ue.length;Y<J;Y++)if(fe=Ue[Y],M.format!==an)if(ae!==null)if(Ie){if(U)if(M.layerUpdates.size>0){const oe=Oh(fe.width,fe.height,M.format,M.type);for(const de of M.layerUpdates){const Ye=fe.data.subarray(de*oe/fe.data.BYTES_PER_ELEMENT,(de+1)*oe/fe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,de,fe.width,fe.height,1,ae,Ye,0,0)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,fe.width,fe.height,Q.depth,ae,fe.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Y,be,fe.width,fe.height,Q.depth,0,fe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ie?U&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,fe.width,fe.height,Q.depth,ae,Ae,fe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Y,be,fe.width,fe.height,Q.depth,0,ae,Ae,fe.data)}else{Ie&&st&&t.texStorage2D(i.TEXTURE_2D,ue,be,Ue[0].width,Ue[0].height);for(let Y=0,J=Ue.length;Y<J;Y++)fe=Ue[Y],M.format!==an?ae!==null?Ie?U&&t.compressedTexSubImage2D(i.TEXTURE_2D,Y,0,0,fe.width,fe.height,ae,fe.data):t.compressedTexImage2D(i.TEXTURE_2D,Y,be,fe.width,fe.height,0,fe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ie?U&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,fe.width,fe.height,ae,Ae,fe.data):t.texImage2D(i.TEXTURE_2D,Y,be,fe.width,fe.height,0,ae,Ae,fe.data)}else if(M.isDataArrayTexture)if(Ie){if(st&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ue,be,Q.width,Q.height,Q.depth),U)if(M.layerUpdates.size>0){const Y=Oh(Q.width,Q.height,M.format,M.type);for(const J of M.layerUpdates){const oe=Q.data.subarray(J*Y/Q.data.BYTES_PER_ELEMENT,(J+1)*Y/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,J,Q.width,Q.height,1,ae,Ae,oe)}M.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ae,Ae,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,be,Q.width,Q.height,Q.depth,0,ae,Ae,Q.data);else if(M.isData3DTexture)Ie?(st&&t.texStorage3D(i.TEXTURE_3D,ue,be,Q.width,Q.height,Q.depth),U&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ae,Ae,Q.data)):t.texImage3D(i.TEXTURE_3D,0,be,Q.width,Q.height,Q.depth,0,ae,Ae,Q.data);else if(M.isFramebufferTexture){if(st)if(Ie)t.texStorage2D(i.TEXTURE_2D,ue,be,Q.width,Q.height);else{let Y=Q.width,J=Q.height;for(let oe=0;oe<ue;oe++)t.texImage2D(i.TEXTURE_2D,oe,be,Y,J,0,ae,Ae,null),Y>>=1,J>>=1}}else if(Ue.length>0){if(Ie&&st){const Y=Ee(Ue[0]);t.texStorage2D(i.TEXTURE_2D,ue,be,Y.width,Y.height)}for(let Y=0,J=Ue.length;Y<J;Y++)fe=Ue[Y],Ie?U&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,ae,Ae,fe):t.texImage2D(i.TEXTURE_2D,Y,be,ae,Ae,fe);M.generateMipmaps=!1}else if(Ie){if(st){const Y=Ee(Q);t.texStorage2D(i.TEXTURE_2D,ue,be,Y.width,Y.height)}U&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ae,Ae,Q)}else t.texImage2D(i.TEXTURE_2D,0,be,ae,Ae,Q);p(M)&&f(x),Z.__version=F.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function $(w,M,A){if(M.image.length!==6)return;const x=Xe(w,M),L=M.source;t.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+A);const F=n.get(L);if(L.version!==F.__version||x===!0){t.activeTexture(i.TEXTURE0+A);const Z=Ke.getPrimaries(Ke.workingColorSpace),k=M.colorSpace===ii?null:Ke.getPrimaries(M.colorSpace),G=M.colorSpace===ii||Z===k?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,G);const ye=M.isCompressedTexture||M.image[0].isCompressedTexture,Q=M.image[0]&&M.image[0].isDataTexture,ae=[];for(let J=0;J<6;J++)!ye&&!Q?ae[J]=v(M.image[J],!0,s.maxCubemapSize):ae[J]=Q?M.image[J].image:M.image[J],ae[J]=je(M,ae[J]);const Ae=ae[0],be=r.convert(M.format,M.colorSpace),fe=r.convert(M.type),Ue=b(M.internalFormat,be,fe,M.colorSpace),Ie=M.isVideoTexture!==!0,st=F.__version===void 0||x===!0,U=L.dataReady;let ue=T(M,Ae);pe(i.TEXTURE_CUBE_MAP,M);let Y;if(ye){Ie&&st&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ue,Ue,Ae.width,Ae.height);for(let J=0;J<6;J++){Y=ae[J].mipmaps;for(let oe=0;oe<Y.length;oe++){const de=Y[oe];M.format!==an?be!==null?Ie?U&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,oe,0,0,de.width,de.height,be,de.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,oe,Ue,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ie?U&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,oe,0,0,de.width,de.height,be,fe,de.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,oe,Ue,de.width,de.height,0,be,fe,de.data)}}}else{if(Y=M.mipmaps,Ie&&st){Y.length>0&&ue++;const J=Ee(ae[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ue,Ue,J.width,J.height)}for(let J=0;J<6;J++)if(Q){Ie?U&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,ae[J].width,ae[J].height,be,fe,ae[J].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Ue,ae[J].width,ae[J].height,0,be,fe,ae[J].data);for(let oe=0;oe<Y.length;oe++){const Ye=Y[oe].image[J].image;Ie?U&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,oe+1,0,0,Ye.width,Ye.height,be,fe,Ye.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,oe+1,Ue,Ye.width,Ye.height,0,be,fe,Ye.data)}}else{Ie?U&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,be,fe,ae[J]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Ue,be,fe,ae[J]);for(let oe=0;oe<Y.length;oe++){const de=Y[oe];Ie?U&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,oe+1,0,0,be,fe,de.image[J]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,oe+1,Ue,be,fe,de.image[J])}}}p(M)&&f(i.TEXTURE_CUBE_MAP),F.__version=L.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function te(w,M,A,x,L,F){const Z=r.convert(A.format,A.colorSpace),k=r.convert(A.type),G=b(A.internalFormat,Z,k,A.colorSpace);if(!n.get(M).__hasExternalTextures){const Q=Math.max(1,M.width>>F),ae=Math.max(1,M.height>>F);L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?t.texImage3D(L,F,G,Q,ae,M.depth,0,Z,k,null):t.texImage2D(L,F,G,Q,ae,0,Z,k,null)}t.bindFramebuffer(i.FRAMEBUFFER,w),We(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,x,L,n.get(A).__webglTexture,0,He(M)):(L===i.TEXTURE_2D||L>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&L<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,x,L,n.get(A).__webglTexture,F),t.bindFramebuffer(i.FRAMEBUFFER,null)}function me(w,M,A){if(i.bindRenderbuffer(i.RENDERBUFFER,w),M.depthBuffer){const x=M.depthTexture,L=x&&x.isDepthTexture?x.type:null,F=S(M.stencilBuffer,L),Z=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,k=He(M);We(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,k,F,M.width,M.height):A?i.renderbufferStorageMultisample(i.RENDERBUFFER,k,F,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,F,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,w)}else{const x=M.textures;for(let L=0;L<x.length;L++){const F=x[L],Z=r.convert(F.format,F.colorSpace),k=r.convert(F.type),G=b(F.internalFormat,Z,k,F.colorSpace),ye=He(M);A&&We(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ye,G,M.width,M.height):We(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ye,G,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,G,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function he(w,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,w),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),q(M.depthTexture,0);const x=n.get(M.depthTexture).__webglTexture,L=He(M);if(M.depthTexture.format===as)We(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,x,0,L):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,x,0);else if(M.depthTexture.format===vs)We(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,x,0,L):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,x,0);else throw new Error("Unknown depthTexture format")}function Te(w){const M=n.get(w),A=w.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==w.depthTexture){const x=w.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),x){const L=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,x.removeEventListener("dispose",L)};x.addEventListener("dispose",L),M.__depthDisposeCallback=L}M.__boundDepthTexture=x}if(w.depthTexture&&!M.__autoAllocateDepthBuffer){if(A)throw new Error("target.depthTexture not supported in Cube render targets");he(M.__webglFramebuffer,w)}else if(A){M.__webglDepthbuffer=[];for(let x=0;x<6;x++)if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[x]),M.__webglDepthbuffer[x]===void 0)M.__webglDepthbuffer[x]=i.createRenderbuffer(),me(M.__webglDepthbuffer[x],w,!1);else{const L=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,F=M.__webglDepthbuffer[x];i.bindRenderbuffer(i.RENDERBUFFER,F),i.framebufferRenderbuffer(i.FRAMEBUFFER,L,i.RENDERBUFFER,F)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=i.createRenderbuffer(),me(M.__webglDepthbuffer,w,!1);else{const x=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,L=M.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,L),i.framebufferRenderbuffer(i.FRAMEBUFFER,x,i.RENDERBUFFER,L)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Se(w,M,A){const x=n.get(w);M!==void 0&&te(x.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),A!==void 0&&Te(w)}function Ge(w){const M=w.texture,A=n.get(w),x=n.get(M);w.addEventListener("dispose",R);const L=w.textures,F=w.isWebGLCubeRenderTarget===!0,Z=L.length>1;if(Z||(x.__webglTexture===void 0&&(x.__webglTexture=i.createTexture()),x.__version=M.version,a.memory.textures++),F){A.__webglFramebuffer=[];for(let k=0;k<6;k++)if(M.mipmaps&&M.mipmaps.length>0){A.__webglFramebuffer[k]=[];for(let G=0;G<M.mipmaps.length;G++)A.__webglFramebuffer[k][G]=i.createFramebuffer()}else A.__webglFramebuffer[k]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){A.__webglFramebuffer=[];for(let k=0;k<M.mipmaps.length;k++)A.__webglFramebuffer[k]=i.createFramebuffer()}else A.__webglFramebuffer=i.createFramebuffer();if(Z)for(let k=0,G=L.length;k<G;k++){const ye=n.get(L[k]);ye.__webglTexture===void 0&&(ye.__webglTexture=i.createTexture(),a.memory.textures++)}if(w.samples>0&&We(w)===!1){A.__webglMultisampledFramebuffer=i.createFramebuffer(),A.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,A.__webglMultisampledFramebuffer);for(let k=0;k<L.length;k++){const G=L[k];A.__webglColorRenderbuffer[k]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,A.__webglColorRenderbuffer[k]);const ye=r.convert(G.format,G.colorSpace),Q=r.convert(G.type),ae=b(G.internalFormat,ye,Q,G.colorSpace,w.isXRRenderTarget===!0),Ae=He(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ae,ae,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+k,i.RENDERBUFFER,A.__webglColorRenderbuffer[k])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(A.__webglDepthRenderbuffer=i.createRenderbuffer(),me(A.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(F){t.bindTexture(i.TEXTURE_CUBE_MAP,x.__webglTexture),pe(i.TEXTURE_CUBE_MAP,M);for(let k=0;k<6;k++)if(M.mipmaps&&M.mipmaps.length>0)for(let G=0;G<M.mipmaps.length;G++)te(A.__webglFramebuffer[k][G],w,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+k,G);else te(A.__webglFramebuffer[k],w,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+k,0);p(M)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Z){for(let k=0,G=L.length;k<G;k++){const ye=L[k],Q=n.get(ye);t.bindTexture(i.TEXTURE_2D,Q.__webglTexture),pe(i.TEXTURE_2D,ye),te(A.__webglFramebuffer,w,ye,i.COLOR_ATTACHMENT0+k,i.TEXTURE_2D,0),p(ye)&&f(i.TEXTURE_2D)}t.unbindTexture()}else{let k=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(k=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(k,x.__webglTexture),pe(k,M),M.mipmaps&&M.mipmaps.length>0)for(let G=0;G<M.mipmaps.length;G++)te(A.__webglFramebuffer[G],w,M,i.COLOR_ATTACHMENT0,k,G);else te(A.__webglFramebuffer,w,M,i.COLOR_ATTACHMENT0,k,0);p(M)&&f(k),t.unbindTexture()}w.depthBuffer&&Te(w)}function qe(w){const M=w.textures;for(let A=0,x=M.length;A<x;A++){const L=M[A];if(p(L)){const F=w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Z=n.get(L).__webglTexture;t.bindTexture(F,Z),f(F),t.unbindTexture()}}}const ze=[],D=[];function Ct(w){if(w.samples>0){if(We(w)===!1){const M=w.textures,A=w.width,x=w.height;let L=i.COLOR_BUFFER_BIT;const F=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Z=n.get(w),k=M.length>1;if(k)for(let G=0;G<M.length;G++)t.bindFramebuffer(i.FRAMEBUFFER,Z.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+G,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Z.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+G,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Z.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Z.__webglFramebuffer);for(let G=0;G<M.length;G++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(L|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(L|=i.STENCIL_BUFFER_BIT)),k){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Z.__webglColorRenderbuffer[G]);const ye=n.get(M[G]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ye,0)}i.blitFramebuffer(0,0,A,x,0,0,A,x,L,i.NEAREST),l===!0&&(ze.length=0,D.length=0,ze.push(i.COLOR_ATTACHMENT0+G),w.depthBuffer&&w.resolveDepthBuffer===!1&&(ze.push(F),D.push(F),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,D)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ze))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),k)for(let G=0;G<M.length;G++){t.bindFramebuffer(i.FRAMEBUFFER,Z.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+G,i.RENDERBUFFER,Z.__webglColorRenderbuffer[G]);const ye=n.get(M[G]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Z.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+G,i.TEXTURE_2D,ye,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Z.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const M=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function He(w){return Math.min(s.maxSamples,w.samples)}function We(w){const M=n.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function we(w){const M=a.render.frame;h.get(w)!==M&&(h.set(w,M),w.update())}function je(w,M){const A=w.colorSpace,x=w.format,L=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||A!==bt&&A!==ii&&(Ke.getTransfer(A)===at?(x!==an||L!==Wn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",A)),M}function Ee(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=W,this.resetTextureUnits=E,this.setTexture2D=q,this.setTexture2DArray=ee,this.setTexture3D=X,this.setTextureCube=ne,this.rebindTextures=Se,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=qe,this.updateMultisampleRenderTarget=Ct,this.setupDepthRenderbuffer=Te,this.setupFrameBufferTexture=te,this.useMultisampledRTT=We}function Tv(i,e){function t(n,s=ii){let r;const a=Ke.getTransfer(s);if(n===Wn)return i.UNSIGNED_BYTE;if(n===Kl)return i.UNSIGNED_SHORT_4_4_4_4;if(n===$l)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ku)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===ju)return i.BYTE;if(n===Yu)return i.SHORT;if(n===sr)return i.UNSIGNED_SHORT;if(n===Yl)return i.INT;if(n===Ni)return i.UNSIGNED_INT;if(n===gn)return i.FLOAT;if(n===nn)return i.HALF_FLOAT;if(n===$u)return i.ALPHA;if(n===Zu)return i.RGB;if(n===an)return i.RGBA;if(n===Ju)return i.LUMINANCE;if(n===Qu)return i.LUMINANCE_ALPHA;if(n===as)return i.DEPTH_COMPONENT;if(n===vs)return i.DEPTH_STENCIL;if(n===Zl)return i.RED;if(n===Jl)return i.RED_INTEGER;if(n===ed)return i.RG;if(n===Ql)return i.RG_INTEGER;if(n===ec)return i.RGBA_INTEGER;if(n===$r||n===Zr||n===Jr||n===Qr)if(a===at)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===$r)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Zr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Jr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Qr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===$r)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Zr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Jr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Qr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Xo||n===qo||n===jo||n===Yo)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Xo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===qo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===jo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Yo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ko||n===$o||n===Zo)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ko||n===$o)return a===at?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Zo)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Jo||n===Qo||n===el||n===tl||n===nl||n===il||n===sl||n===rl||n===al||n===ol||n===ll||n===cl||n===hl||n===ul)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Jo)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Qo)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===el)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===tl)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===nl)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===il)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===sl)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===rl)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===al)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ol)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ll)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===cl)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===hl)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ul)return a===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ea||n===dl||n===fl)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===ea)return a===at?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===dl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===fl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===td||n===pl||n===ml||n===gl)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===ea)return r.COMPRESSED_RED_RGTC1_EXT;if(n===pl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ml)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===gl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===_s?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class wv extends At{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ri extends ct{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Av={type:"move"};class po{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ri,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ri,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new I,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new I),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ri,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new I,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new I),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const v of e.hand.values()){const p=t.getJointPose(v,n),f=this._getHandJoint(c,v);p!==null&&(f.matrix.fromArray(p.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=p.radius),f.visible=p!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),m=.02,g=.005;c.inputState.pinching&&d>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Av)))}return o!==null&&(o.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new ri;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Rv=`
void main() {
...
/* Cover: wine-red leather with a gold embossed edge */
...
#passport-screen .photo:after{
  content:"PHOTOGRAPH";position:absolute;z-index:2;bottom:6px;left:0;right:0;text-align:center;
...
<div class="passport" id="passport-screen">
  ...
  <div class="book">
    ...
    <section class="page left">
      ...
      <div class="micro">REPUBLIC OF ZORVANIA • REPUBLIC OF ZORVANIA • REPUBLIC OF ZORVANIA • REPUBLIC OF ZORVANIA</div>
      ...
      <div class="header">
        ...
        <div class="country">REPUBLIC OF ZORVANIA</div>
        <div class="subtitle">REPUBLIC OF ZORVANIA</div>
        <div class="doc-title">PASSPORT</div>
        <div class="doc-sub">CITIZEN OF THE REPUBLIC OF ZORVANIA</div>
      </div>
      <div class="rule"></div>
      ...
      <div class="identity">
        <div>
          <div class="photo">
            ...
            <span class="photo-initials" data-passport="photo">E.M</span>
          </div>
        ...
        <div>
          <div class="field"><div class="label">SURNAME</div><div class="value" data-passport="surname">MORROW</div></div>
          <div class="field"><div class="label">GIVEN NAMES</div><div class="value" data-passport="givenNames">ELEANOR GRACE</div></div>
          <div class="two">
            <div class="field"><div class="label">SEX</div><div class="value" data-passport="sex">F</div></div>
            <div class="field"><div class="label">NATIONALITY</div><div class="value" data-passport="nationality">ZORVANIA</div></div>
          </div>
          <div class="two">
            <div class="field"><div class="label">DATE OF BIRTH</div><div class="value" data-passport="dob">17.04.1987</div></div>
            <div class="field"><div class="label">PLACE OF BIRTH</div><div class="value" data-passport="pob">MOSCOW</div></div>
          </div>
          <div class="two">
            <div class="field"><div class="label">DATE OF ISSUE</div><div class="value" data-passport="issue">28.08.2022</div></div>
            <div class="field"><div class="label">EXPIRY DATE</div><div class="value" data-passport="expiry">28.08.2032</div></div>
          </div>
          <div class="field"><div class="label">ISSUING AUTHORITY</div><div class="value" data-passport="authority">MINISTRY OF INTERNAL AFFAIRS</div></div>
          <div class="two">
            <div class="field"><div class="label">APT.</div><div class="value" data-passport="apartment">7</div></div>
            <div class="field"><div class="label">TEL.</div><div class="value" data-passport="phone">55-41-08</div></div>
          </div>
        </div>
      </div>

      <div class="mrz">
        <span data-passport="mrz1">P&lt;ZrVMORROW&lt;&lt;ELEANOR&lt;GRACE&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;</span><br>
        <span data-passport="mrz2">VER4763821&lt;ZRV&lt;870417&lt;F&lt;320828&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;&lt;08</span>
      </div>
    ...
    <section class="page right">
      <div class="security"></div>
      <div class="micro">ZORVANIA • ZORVANIA • ZORVANIA • ZORVANIA • ZORVANIA • ZORVANIA</div>
      <div class="map">☨</div>
      <div class="visa-title">VISAS / VISAS / VISAS</div>

      <div class="stamp s1"><b>REPUBLIC OF ZORVANIA</b><br>EXIT<br>28.08.2022<br>MOSCOW VNUKOVO<br>B17</div>
      <div class="stamp s2"><b>SOUTHERN ZORVANIA</b><br>ENTRY<br>30.08.2022<br>ZORVANIA AIRPORT<br>A 012</div>
      <div class="stamp s3"><b>EDRANIA FEDERATION</b><br>ENTRY<br>02.09.2022<br>EDRAN CITY PORT<br>0123</div>
      <div class="stamp s4"><b>REPUBLIC OF ZORVANIA</b><br>ENTRY<br>12.09.2022<br>MOSCOW<br>B17</div>
      <div class="stamp s5"><b>KAELAN UNION</b><br>EXIT<br>15.09.2022<br>KAE PORT<br>78</div>
      <div class="stamp s6"><b>REPUBLIC OF ZORVANIA</b><br>EXIT<br>27.09.2022<br>MOSCOW<br>B17</div>
...
(function () {
  var SAMPLE = {
    ...
    signature: 'E. Morrow',
    photo: 'E.M',
    mrz1: 'P<ZrVMORROW<<ELEANOR<GRACE<<<<<<<<<<<<<<<<<<<<',
    mrz2: 'VER4763821<ZRV<870417<F<320828<<<<<<<<<<<<08',
  };
...
`,Cl=320,Ll=400,Hy=1.75,Lo=new Map,Ws=new Map;let ti=null,On=null,sa=null;function Vy(){if(ti)return;ti=new oc({antialias:!0,preserveDrawingBuffer:!0}),ti.setSize(Cl,Ll),ti.setPixelRatio(1),ti.toneMapping=hr,ti.toneMappingExposure=1.15,On=new cc,On.background=new ve(9410979),sa=new At(35,Cl/Ll,.1,20),sa.position.set(0,1.42,1.3),sa.lookAt(0,1.42,0),On.add(new Id(16777215,5596791,1.3));const i=new Vn(16773853,2.2);i.position.set(1.1,2.2,1.3),On.add(i);const e=new Vn(13623551,.7);e.position.set(-1.3,.9,.9),On.add(e);const t=new Vn(16777215,1);t.position.set(.2,2.1,-1.4),On.add(t)}function Gy(i){i.traverse(e=>{var t;e.isMesh&&((t=e.geometry)==null||t.dispose(),(Array.isArray(e.material)?e.material:[e.material]).forEach(s=>s==null?void 0:s.dispose()))})}function Wy(i){Vy(),i.updateMatrixWorld(!0);const e=new Ne().setFromObject(i),t=e.getSize(new I).y;i.scale.multiplyScalar(Hy/t),i.updateMatrixWorld(!0),e.setFromObject(i),i.position.set(0,-e.min.y,0),i.rotation.set(0,0,0),On.add(i),ti.render(On,sa);const n=document.createElement("canvas");return n.width=Cl,n.height=Ll,n.getContext("2d").drawImage(ti.domElement,0,0),On.remove(i),n}function Gd(i,e){if(Lo.has(i)){e==null||e(Lo.get(i));return}if(Ws.has(i)){Ws.get(i).push(e);return}Ws.set(i,[e]);const t=s=>{const r=Ws.get(i);Ws.delete(i),s&&Lo.set(i,s),r.forEach(a=>a==null?void 0:a(s))},n=xc[i];if(!n){t(null);return}_a(n).then(s=>{if(!s){t(null);return}const r=Al(s),a=Wy(r);Gy(r),t(a)})}const Il=640,Pl=420,Xy=new rt;let ni=null,Bn=null,ra=null,aa=null,Xs=null;function qy(){if(ni)return;ni=new oc({antialias:!0,preserveDrawingBuffer:!0,alpha:!0}),ni.setSize(Il,Pl),ni.setPixelRatio(1),ni.toneMapping=hr,ni.toneMappingExposure=1.3,Bn=new cc,ra=new At(35,Il/Pl,.01,20),ra.position.set(0,0,4),ra.lookAt(0,0,0),Bn.add(new Id(16777215,5588019,1.1));const i=new Vn(16770756,3.4);i.position.set(2.4,3.2,2.4),Bn.add(i);const e=new Vn(16767400,1.6);e.position.set(-2.6,1.6,2.2),Bn.add(e);const t=new Vn(13623551,.7);t.position.set(-2.8,.6,-1.5),Bn.add(t);const n=new Vn(16777215,1.6);n.position.set(.6,2.8,-3.2),Bn.add(n)}function jy(i){i.traverse(e=>{var t;e.isMesh&&((t=e.geometry)==null||t.dispose(),(Array.isArray(e.material)?e.material:[e.material]).forEach(s=>s==null?void 0:s.dispose()))})}function Yy(i){qy(),i.rotation.set(.5,.85,.08),i.updateMatrixWorld(!0);const e=new Ne().setFromObject(i),t=e.getSize(new I),n=e.getCenter(new I);i.position.sub(n);const s=1.3;i.scale.multiplyScalar(s/t.y),i.position.y+=s*.19,i.updateMatrixWorld(!0),Bn.add(i),ni.render(Bn,ra);const r=document.createElement("canvas");return r.width=Il,r.height=Pl,r.getContext("2d").drawImage(ni.domElement,0,0),Bn.remove(i),r}function Mu(){return aa}function Wd(i){if(aa){i==null||i(aa);return}if(Xs){Xs.push(i);return}Xs=[i];const e=t=>{const n=Xs;Xs=null,t&&(aa=t),n.forEach(s=>s==null?void 0:s(t))};Xy.load(Fd,t=>{const n=Yy(t.scene);jy(t.scene),e(n)},void 0,t=>{console.warn("keys render: failed to load keys.glb:",t),e(null)})}const Xd="nightshift_hints";let us=!1;function ya(){return us}function Ky(i){us=!!i;try{localStorage.setItem(Xd,String(us))}catch{}}function $y(){try{us=localStorage.getItem(Xd)==="true"}catch{us=!1}return us}const qd=document.getElementById("item-screen");document.getElementById("item-stage");const Sa=document.getElementById("item-passport"),Ri=document.getElementById("item-stamp"),Zy=document.getElementById("item-claimed"),Jy=["keys","letter","book","paperball"],Qy=i=>i==="paper ball"?"paperball":i;let Ea=!1,Ci=null,yu=0;function eS(){if(Ci)return;const i=new DOMParser().parseFromString(zy,"text/html"),e=i.querySelector("style"),t=i.getElementById("passport-screen");e&&Sa.appendChild(e),t&&(Sa.appendChild(t),Ci=t)}function tS(i,e){i.querySelectorAll("[data-passport]").forEach(t=>{const n=t.getAttribute("data-passport");e[n]!==void 0&&e[n]!==null&&e[n]!==""&&(t.textContent=e[n])})}function jd(){return Ea}const Su={passport:()=>Ci,keys:()=>document.querySelector("#item-keys .keys-3d"),letter:()=>document.querySelector("#item-letter .sheet"),book:()=>document.querySelector("#item-book .bookobj"),paperball:()=>document.querySelector("#item-paperball .receipt")};function Eu(i){Ri.remove(),i&&i.appendChild(Ri)}function nS(i,e){const t=Qy(i),n=e.dataFor?e.dataFor(t):null;if(n){if(qd.classList.remove("hidden"),Ea=!0,Jy.forEach(s=>document.getElementById(`item-${s}`).classList.add("hidden")),Sa.classList.add("hidden"),t==="passport"){eS(),tS(Ci,n);const s=Ci.querySelector(".photo"),r=Ci.querySelector(".photo-img");s.classList.remove("has-photo");const a=++yu,o=e.claimed.name;Gd(o,l=>{a!==yu||!Ea||!l||(r.width=l.width,r.height=l.height,r.getContext("2d").drawImage(l,0,0),s.classList.add("has-photo"))}),Sa.classList.remove("hidden"),Eu(Ci)}else{const s=document.getElementById(`item-${t}`);if(s.querySelectorAll("[data-item]").forEach(r=>{const a=r.getAttribute("data-item");n[a]!==void 0&&n[a]!==null&&n[a]!==""&&(r.textContent=n[a])}),s.classList.remove("hidden"),t==="keys"){const r=s.querySelector(".keys-img"),a=o=>{!o||!r||(r.width=o.width,r.height=o.height,r.getContext("2d").drawImage(o,0,0))};a(Mu()),Mu()||Wd(a)}Eu(Su[t]?Su[t]():s)}ya()?(Ri.textContent=n.matches?"✓ MATCHES THE STORY":"✗ CONTRADICTS THE STORY",Ri.classList.toggle("good",n.matches),Ri.classList.toggle("bad",!n.matches),Ri.classList.remove("hidden")):Ri.classList.add("hidden"),Zy.textContent=`CLAIMED: ${e.claimed.name.toUpperCase()} — APARTMENT ${e.claimed.apartment}`}}function bu(){qd.classList.add("hidden"),Ea=!1}const iS=""+new URL("log-CarpyEKp.png",import.meta.url).href,Yd=document.getElementById("log-screen"),sS=document.getElementById("log-image");let Ec=!1;function Kd(){return Ec}function rS(){sS.src=iS,Yd.classList.remove("hidden"),Ec=!0}function Tu(){Yd.classList.add("hidden"),Ec=!1}const Cs=document.getElementById("dialogue-screen"),aS=Cs.querySelector(".dialogue-name"),oS=Cs.querySelector(".dialogue-greeting"),wu=Cs.querySelector(".dialogue-questions"),Xr=Cs.querySelector(".dialogue-answer");let bc=!1;function $d(){return bc}function lS(i,e={}){aS.textContent=i.claimed.name.toUpperCase(),oS.textContent=`“${i.greeting}”`,wu.innerHTML="",Xr.classList.add("hidden"),Xr.textContent="",i.questions.forEach(t=>{const n=document.createElement("button");n.type="button",n.className="dialogue-q",n.innerHTML=`<span class="dialogue-q-text">${t.prompt}</span>`,n.addEventListener("click",()=>{var a;const s=i.ask(t.qid);if(n.classList.add("asked"),ya()){const o=document.createElement("span");o.className=`chip ${s.match?"good":"bad"}`,o.textContent=s.match?"MATCHES":"CONTRADICTS",n.appendChild(o)}const r=ya()?`<span class="chip ${s.match?"good":"bad"}">${s.match?"MATCHES":"CONTRADICTS"}</span>`:"";Xr.innerHTML=`
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`})}getEdgeDetectionMaterial(){return new Ut({uniforms:{maskTexture:{value:null},texSize:{value:new Ce(.5,.5)},visibleEdgeColor:{value:new I(1,1,1)},hiddenEdgeColor:{value:new I(1,1,1)}},vertexShader:`varying vec2 vUv;
		...
		}`};class LS extends Ls{constructor(){super();const e=CS;this.uniforms=Ca.clone(e.uniforms),this.material=new Wv({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new wc(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Ke.getTransfer(this._outputColorSpace)===at&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===zu?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===Hu?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===Vu?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===hr?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===Gu?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===Wu&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}const IS=document.getElementById("app"),Ac=document.getElementById("title"),rf=document.getElementById("howto"),PS=document.getElementById("crosshair"),lr=document.getElementById("interact-hint"),qs=document.getElementById("result-banner"),Rc=document.getElementById("gameover"),DS=document.getElementById("gameover-reason"),af=document.getElementById("night-complete"),Cc=document.getElementById("victory"),Pa=document.getElementById("hud"),US=document.getElementById("hud-label"),NS=document.getElementById("hud-clock"),FS=document.getElementById("hud-score"),Io=document.getElementById("banner"),Yr=null,Fi=new cc;Fi.background=new ve(329227);Fi.fog=new lc(460813,6,30);const zt=new At(75,innerWidth/innerHeight,.1,80);zt.position.set(0,1.7,1);const Wt=new oc({antialias:!0});Wt.setSize(innerWidth,innerHeight);Wt.setPixelRatio(Math.min(devicePixelRatio,1.5));Wt.shadowMap.enabled=!0;Wt.shadowMap.type=jl;Wt.toneMapping=hr;Wt.toneMappingExposure=1.15;IS.appendChild(Wt.domElement);const{bounds:OS,colliders:BS,lightsAreOn:kS,setLights:zS,runBlackout:HS}=DM(Fi),St=new py(Fi);let Fl=0;const of=()=>{const i=St.modelName;return i==="The Girl"||i.endsWith("a")};St.onStep=()=>{of()||yc(Sc)};St.onWalkStart=()=>{const i=++Fl;of()&&yc(Vd).then(e=>{i!==Fl&&Hd()})};St.onWalkStop=()=>{Fl++,Hd()};const ke=new vy;let wt=null,Mn=!1,bi=null,Lu=null,Iu=null,Pu=null,bs=!1;const Du=document.getElementById("pause-screen");let ba=!1;function VS(){try{document.pointerLockElement&&document.exitPointerLock()}catch{}Et.controls.unlock()}function mr(i,e={}){bs!==i&&(bs=i,i?(Cy(),Du.classList.remove("hidden"),VS()):(Ly(),Du.classList.add("hidden"),!e.noLock&&!Mn&&!Da()&&(ba=!0,Et.lock())))}document.addEventListener("pointerlockerror",()=>{ba&&(ba=!1,mr(!0))});const Da=()=>jd()||Kd()||$d()||Zd()||xS(),Is=new AS(Wt);Is.addPass(new RS(Fi,zt));const Nt=new oi(new Ce(innerWidth,innerHeight),Fi,zt);Nt.visibleEdgeColor=new ve(16777215);Nt.hiddenEdgeColor=new ve(0);Nt.edgeGlow=.9;Nt.edgeThickness=2;Nt.edgeStrength=3.5;Nt.pulsePeriod=0;Nt.enabled=!1;Is.addPass(Nt);Is.addPass(new LS);const Uu=new Mx,GS=new Ce(0,0);let Ol=null,dn=null,Nu=!1;function WS(){let i=null,e=null;const t=ke.night===1&&ke.visitorNumber()===1;if(Et.locked){zt.updateMatrixWorld(),Uu.setFromCamera(GS,zt);const r=Uu.intersectObjects(Fi.children,!0)[0];r&&r.object.userData.interact&&(i=r.object.userData.interactObj,e=r.object.userData.interact,lr.textContent=t?r.object.userData.prompt||`Press E to check the ${e}`:"")}const n=!!i;(i!==Ol||n!==Nu)&&(Ol=i,dn=e,Nt.selectedObjects=i?[i]:[],Nt.enabled=!!i,Nu=n,lr.classList.toggle("hidden",!t||!i))}function XS(){US.textContent=`NIGHT ${ke.night} — VISITOR ${ke.visitorNumber()}/${ke.nightStats.total}`,FS.textContent=`SCORE ${ke.runScore}`}const lf=i=>{const e=Math.floor(i/60),t=Math.floor(i%60);return`${String(e).padStart(2,"0")}:${String(t).padStart(2,"0")}`};function qS(i,e,t=5e3){Io.innerHTML=`<span class="banner-title">${i}</span>`+(e?`<span class="banner-sub">${e}</span>`:""),Io.classList.remove("hidden"),clearTimeout(Iu),Iu=setTimeout(()=>Io.classList.add("hidden"),t)}function cf(){const i=ga[ke.night];qS(`NIGHT ${ke.night}`,`${i.visitors} visitors tonight`,4500)}let Bl=[],Lc=null,Ic=!1;function hf(){clearTimeout(Lc),Bl=[];const i=ke.night;if(i<3)return;const e=i>=6?2:1,t=[];for(let n=0;n<ke.nightStats.total-1;n++)t.push(n);for(let n=t.length-1;n>0;n--){const s=Math.floor(Math.random()*(n+1));[t[n],t[s]]=[t[s],t[n]]}Bl=t.slice(0,Math.min(e,t.length))}let kl=!1,Js=!1;const Ta=1.7;function jS(i){if(!Bl.includes(ke.visitorNumber()-1))return;const e=2e3+Math.random()*4e3;Lc=setTimeout(()=>{if(Mn||Ic||bs||!ke.currentVisitor()||ke.currentVisitor()!==i)return;const t=4e3+Math.random()*3e3;Uy(),HS(t,{onOut:()=>{Ny(),kl=!0,i.isImpostor&&ke.currentVisitor()===i&&St.group&&St.swapModel(kd(ke.night),{height:Ta,name:i.claimed.name,isTrueForm:!0})},onRestore:()=>{Fy(),kl=!1,i.isImpostor&&ke.currentVisitor()===i&&St.group&&St.state!=="departing"&&St.swapModel(St.modelUrl,{height:Ta,name:i.claimed.name})}})},e)}function Pc(i){wt=i,Ic=!1,Js=!1,St.spawn(i.claimed.name),XS(),jS(i)}function YS(i,e){qs.textContent=i,qs.classList.remove("good","bad"),qs.classList.add("good"),qs.classList.add("visible"),clearTimeout(Lu),Lu=setTimeout(()=>qs.classList.remove("visible"),2300)}function KS(){return`
    ...
    <div class="stat"><span>Score</span><b>${ke.runScore}</b></div>`,document.getElementById("nc-continue").textContent=`Start Night ${ke.night+1}`,af.classList.remove("hidden"),lr.classList.add("hidden"),Nt.selectedObjects=[],Nt.enabled=!1,Et.controls.unlock()}function rE(){Mn=!0,document.getElementById("victory-stats").innerHTML=KS(),Cc.classList.remove("hidden"),lr.classList.add("hidden"),Nt.selectedObjects=[],Nt.enabled=!1,Et.controls.unlock(),Rl(),setTimeout(Rl,350)}function Ou(i){if(Mn||Da()||!wt)return;ht();const e=Ol;if(e&&(e.position.z-=.02,setTimeout(()=>{e.position.z+=.02},160)),i==="green"?!wt.isImpostor:wt.isImpostor){Ic=!0,Rl();const n=i==="green"?`✓ ${wt.claimed.name} — allowed in`:`✓ ${wt.claimed.name} — shapeshifter, denied`;YS(n);const s=ke.registerDecision(i),r=!!wt.bossType,a=wt.isImpostor&&!kl&&(r||Math.random()<.25),o=()=>{St.depart(),s==="victory"?(clearTimeout(bi),bi=setTimeout(rE,1400)):s==="nightcomplete"?(clearTimeout(bi),bi=setTimeout(sE,1400)):(clearTimeout(bi),bi=setTimeout(()=>{const l=ke.nextVisitor();l&&Pc(l)},2e3))};if(a){Js=!0;const l=kd(ke.night),c=St.modelUrl;St.swapModel(l,{height:Ta,name:wt.claimed.name,isTrueForm:!0,onLoaded:()=>{setTimeout(()=>{Js&&St.swapModel(c,{height:Ta,name:wt.claimed.name,onLoaded:()=>{setTimeout(()=>{Js&&(Js=!1,o())},900)}})},1e3)}})}else o()}else{Py();const n=i==="green",s=n?"You let a shapeshifter into the building.":"You turned away a real resident.",r=n?{head:"WHAT YOU MISSED",lines:nE(wt)}:{head:"THEY WERE REAL",lines:["Everything checked out — passport, belongings, phone line and answers all matched the journal."]},a=n?JS(wt):tE(wt);ke.registerDecision(i),iE(s,r,a)}}function js(i){ke.toolsUsed(i)}const aE={onAsk:()=>ht()},oE={onCall:()=>Dy()};document.addEventListener("keydown",i=>{if(i.code==="Escape"){if(!cr.classList.contains("hidden")){cr.classList.add("hidden"),!Du.classList.contains("hidden")||Ac.classList.remove("hidden");return}if(!mf.classList.contains("hidden")){mf.classList.add("hidden"),Ac.classList.remove("hidden");return}if(Da()){bu(),Tu(),Au(),Ru();return}return}if(i.code==="KeyP"){Ac.classList.contains("hidden")&&!Mn&&mr(!bs);return}if(i.code==="KeyE"){if(xS()){yS();return}if(jd()||Kd()){bu(),Tu();return}if($d()){Au(),Et.lock();return}if(Zd()){Ru(),Et.lock();return}!Et.locked||Mn||!wt||(dn==="green button"?Ou("green"):dn==="red button"?Ou("red"):dn==="notebook"?(rS(),js("journal")):dn==="phone"?(dS(wt,oE),js("phone"),Et.controls.unlock()):dn==="intercom"?(lS(wt,aE),js("dialogue"),Et.controls.unlock()):dn==="light switch"?(zS(!kS()),ht()):dn&&(nS(dn,wt),dn==="passport"?js("passport"):(js("inspect"),ke.noteInspection(dn))))}});const Ti=document.getElementById("fade"),Ii=document.getElementById("intro-clock");let en=null,wa=null,Po=0;function lE(i){wa=i,Ti.style.transition="none",Ti.style.opacity="1",Ti.classList.remove("hidden"),Ti.offsetWidth,Ti.style.transition="opacity 3.5s ease",Ti.style.opacity="0",Ii.textContent="23:58",Ii.style.opacity="1",Ii.classList.remove("hidden");const e=new I(4,1.4,0),t=zt.quaternion.clone();zt.lookAt(e);const n=zt.quaternion.clone();zt.quaternion.copy(t),en={t0:performance.now(),dur:4.2,startQuat:t,endQuat:n,clockAt:0}}function Dc(){Sy(),ke.startGame(),hf(),lE(()=>{MS(St,{onDone:()=>{Pa.classList.remove("hidden"),cf(),Pc(ke.nextVisitor()),Et.lock()}})})}const uf={master:"nightshift_volume",ambience:"nightshift_ambience",sfx:"nightshift_sfx",voice:"nightshift_voice",mute:"nightshift_mute",sens:"nightshift_sens",invertY:"nightshift_invert_y",fov:"nightshift_fov",graphics:"nightshift_graphics",fps:"nightshift_fps",hints:"nightshift_hints"},Fe={master:.85,ambience:1,sfx:1,voice:1,mute:!1,sens:1,invertY:!1,fov:75,graphics:"high",fps:!1,hints:!1};function cE(){const i=(e,t)=>{try{const n=localStorage.getItem(uf[e]);if(n===null)return;t==="float"?Fe[e]=Math.max(0,Math.min(1,parseFloat(n)||0)):t==="num"?Fe[e]=parseFloat(n)||0:t==="bool"?Fe[e]=n==="true":t==="int"?Fe[e]=parseInt(n,10)||0:Fe[e]=n}catch{}};i("master","float"),i("ambience","float"),i("sfx","float"),i("voice","float"),i("mute","bool"),i("sens","num"),i("invertY","bool"),i("fov","int"),i("graphics","str"),i("fps","bool"),i("hints","bool"),Fe.sens=Math.max(.2,Math.min(2,Fe.sens)),Fe.fov=Math.max(60,Math.min(100,Fe.fov)),["low","medium","high"].includes(Fe.graphics)||(Fe.graphics="high")}function Ps(i){try{localStorage.setItem(uf[i],String(Fe[i]))}catch{}}function fi(){by(Fe.master),Ty(Fe.ambience),wy(Fe.sfx),Ay(Fe.voice),Ry(Fe.mute)}function Uc(){Et.controls.pointerSpeed=Fe.sens,Et.invertY=Fe.invertY}function df(){zt.fov=Fe.fov,zt.updateProjectionMatrix()}function ff(){const i=Fe.graphics==="low"?.75:Fe.graphics==="medium"?1:1.5;Wt.setPixelRatio(Math.min(devicePixelRatio,i)),Wt.shadowMap.enabled=Fe.graphics!=="low",Wt.shadowMap.type=Fe.graphics==="high"?jl:ql,Wt.setSize(innerWidth,innerHeight),Is.setSize(innerWidth,innerHeight)}function pf(){_f.classList.toggle("hidden",!Fe.fps),Fe.fps&&(oa=0,Qs=0,Wl=performance.now())}const cr=document.getElementById("settings-screen"),mf=document.getElementById("credits-screen"),gf={master:[document.getElementById("volume-slider"),document.getElementById("volume-value")],ambience:[document.getElementById("ambience-slider"),document.getElementById("ambience-value")],sfx:[document.getElementById("sfx-slider"),document.getElementById("sfx-value")],voice:[document.getElementById("voice-slider"),document.getElementById("voice-value")],sens:[document.getElementById("sens-slider"),document.getElementById("sens-value")],fov:[document.getElementById("fov-slider"),document.getElementById("fov-value")]},zl=document.getElementById("mute-toggle"),Hl=document.getElementById("invert-y-toggle"),Vl=document.getElementById("fps-toggle"),Gl=document.getElementById("hints-toggle"),_f=document.getElementById("fps-counter");let oa=0,Qs=0,Bu=60,Wl=performance.now();const vf={low:document.getElementById("gfx-low"),medium:document.getElementById("gfx-medium"),high:document.getElementById("gfx-high")};function Ua(){for(const[i,[e,t]]of Object.entries(gf)){const n=i==="fov"?Fe.fov:Math.round(Fe[i]*100);e.value=String(n),t.textContent=String(n)}zl.checked=Fe.mute,Hl.checked=Fe.invertY,Vl.checked=Fe.fps,Gl.checked=Fe.hints;for(const[i,e]of Object.entries(vf))e.classList.toggle("active",Fe.graphics===i)}function Ds(i,e,t){const[n,s]=gf[i];n.addEventListener("input",()=>{Fe[i]=e(n.value),s.textContent=n.value,Ps(i),t(),ht()})}Ds("master",i=>i/100,fi);Ds("ambience",i=>i/100,fi);Ds("sfx",i=>i/100,fi);Ds("voice",i=>i/100,fi);Ds("sens",i=>i/100,Uc);Ds("fov",i=>parseInt(i,10),df);zl.addEventListener("change",()=>{Fe.mute=zl.checked,Ps("mute"),fi(),ht()});Hl.addEventListener("change",()=>{Fe.invertY=Hl.checked,Ps("invertY"),Uc(),ht()});Vl.addEventListener("change",()=>{Fe.fps=Vl.checked,Ps("fps"),pf(),ht()});Gl.addEventListener("change",()=>{Fe.hints=Gl.checked,Ps("hints"),Ky(Fe.hints),ht()});for(const[i,e]of Object.entries(vf))e.addEventListener("click",()=>{Fe.graphics=i,Ps("graphics"),ff(),Ua(),ht()});document.getElementById("btn-start").addEventListener("click",function(){Mc();Ui(Sc);Ui(Vd);Ui(zd);fi();Ac.classList.add("hidden");document.getElementById("intro-story").classList.remove("hidden")});document.getElementById("btn-settings").addEventListener("click",()=>{Mc(),fi(),Ua(),ht(),Ac.classList.add("hidden"),cr.classList.remove("hidden")});document.getElementById("btn-settings-close").addEventListener("click",()=>{ht(),cr.classList.add("hidden"),!Du.classList.contains("hidden")||Ac.classList.remove("hidden")});document.getElementById("btn-credits").addEventListener("click",()=>{ht(),Ac.classList.add("hidden"),mf.classList.remove("hidden")});document.getElementById("btn-credits-close").addEventListener("click",()=>{ht(),mf.classList.add("hidden"),Ac.classList.remove("hidden")});document.getElementById("intro-story").addEventListener("click",function(){ht();var is=document.getElementById("intro-story");var slides=is.querySelectorAll(".intro-slide");var cur=-1;for(var i=0;i<slides.length;i++){if(slides[i].classList.contains("active")){cur=i;break}}if(cur>=0)slides[cur].classList.remove("active");if(cur+1<slides.length){slides[cur+1].classList.add("active")}else{is.classList.add("hidden");Dc();var _ph=document.getElementById("pause-hint");_ph.classList.remove("hidden");setTimeout(function(){_ph.style.opacity="0";setTimeout(function(){_ph.classList.add("hidden");_ph.style.opacity=""},1000)},5000)}});document.getElementById("btn-howto").addEventListener("click",()=>{ht(),cr.classList.add("hidden"),rf.classList.remove("hidden")});document.getElementById("btn-howto-close").addEventListener("click",()=>{ht(),rf.classList.add("hidden"),cr.classList.remove("hidden")});document.getElementById("nc-continue").addEventListener("click",()=>{ht(),af.classList.add("hidden"),ke.startNight(ke.night+1),hf(),Pa.classList.remove("hidden"),cf(),Pc(ke.nextVisitor()),Et.lock()});document.getElementById("try-again").addEventListener("click",()=>{ht(),Rc.classList.add("hidden"),Mn=!1,Dc()});function Nc(){mr(!1,{noLock:!0}),Ey(),en=null,wa=null,Rc.classList.add("hidden"),Cc.classList.add("hidden"),Mn=!1,clearTimeout(bi),clearTimeout(Lc),St.depart(),Pa.classList.add("hidden"),Ac.classList.remove("hidden")}document.getElementById("main-menu").addEventListener("click",()=>{ht(),Nc()});document.getElementById("victory-main-menu").addEventListener("click",()=>{ht(),Nc()});document.getElementById("victory-play-again").addEventListener("click",()=>{ht(),Cc.classList.add("hidden"),Mn=!1,Dc()});document.getElementById("pause-resume").addEventListener("click",()=>{ht(),mr(!1)});document.getElementById("pause-main-menu").addEventListener("click",()=>{ht(),mr(!1,{noLock:!0}),Nc()});document.getElementById("pause-settings").addEventListener("click",()=>{ht(),Mc(),fi(),Ua(),cr.classList.remove("hidden")});const Et=new VM(zt,Wt.domElement,OS,BS);Et.onStep=()=>yc(Sc);Et.onLockChange=i=>{PS.classList.toggle("hidden",!i);i&&(ba=!1)};Wt.domElement.addEventListener("click",()=>{if(!document.pointerLockElement&&!bs&&!Mn&&Ac.classList.contains("hidden")){Et.lock()}});cE();$y();Uc();df();ff();pf();Ua();uy();rn.forEach((i,e)=>{setTimeout(()=>Gd(i.name,null),e*120)});Wd(()=>{});addEventListener("resize",()=>{zt.aspect=innerWidth/innerHeight,zt.updateProjectionMatrix(),Wt.setSize(innerWidth,innerHeight),Is.setSize(innerWidth,innerHeight)});const hE=new Dd;function xf(){requestAnimationFrame(xf);const i=Math.min(hE.getDelta(),.05);if(!bs){if(en){const e=(performance.now()-en.t0)/1e3,t=Math.min(e/en.dur,1);if(zt.quaternion.slerpQuaternions(en.startQuat,en.endQuat,t),en.clockAt===0&&e>=1.4?(en.clockAt=1,Ii.textContent="23:59"):en.clockAt===1&&e>=2.9&&(en.clockAt=2,Ii.textContent="00:00"),t>=1){en=null,Ii.style.opacity="0",setTimeout(()=>Ii.classList.add("hidden"),700),Ti.classList.add("hidden");const n=wa;wa=null,n==null||n()}}St.update(i);for(const e of Od)e.update(i);!Da()&&!Mn&&(Et.update(i),WS())}if(!bs&&!Pa.classList.contains("hidden")&&(NS.textContent=lf((Date.now()-ke.nightStats.start)/1e3),Po+=i,Po>=120&&(Po=0,Oy())),Fe.fps){const e=performance.now();Qs+=(e-Wl)/1e3,Wl=e,oa++,Qs>=.5&&(Bu=Math.round(oa/Qs),oa=0,Qs=0),_f.textContent=`FPS ${Bu}`}Is.render()}xf();
